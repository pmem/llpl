...
public class LongArray {
    ...
    /**
     * Stores the supplied {@code long} value at {@code index}.
    ...
    /**
     * Retrieves the {@code long} value at {@code index}.
     * @param index the index from which to retrieve the value
     * @return the {@code long} value stored at {@code index}
     ...
     * and only if the argument is not null and is a {@code LongArray} whose handle is
