...
public class ShortArray {
    ...
    /**
     * Stores the supplied {@code short} value at {@code index}.
    ...
    /**
     * Retrieves the {@code short} value at {@code index}.
     * @param index the index from which to retrieve the value
     * @return the {@code short} value stored at {@code index}
     ...
     * and only if the argument is not null and is a {@code ShortArray} whose handle is
