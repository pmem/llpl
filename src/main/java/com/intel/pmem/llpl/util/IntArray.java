...
/**
 * This class contains a sequence of {@code int} values.
...
public class IntArray {
    ...
    public IntArray(AnyHeap heap, long size) {
        this.arrayBlock = heap.allocateMemoryBlock(Integer.BYTES * size);
    }
    ...
    public void set(long index, int value) {
        ...
        arrayBlock.setInt(Integer.BYTES * index, value);
    }
    ...
    public int get(long index) {
        ...
        return arrayBlock.getInt(Integer.BYTES * index);
    }
