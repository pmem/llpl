...
public class CopyMemoryTest {
    ...
    public static void main(String[] args) {
        ...
        PersistentHeap.deleteHeap(dHeapName);
        TransactionalHeap.deleteHeap(tHeapName);
    ...
    static void blockToBlockTest() {
        ...
        UnboundedMemoryBlock umb = heap.allocateUnboundedMemoryBlock(150, true);
        ...
        Transaction.run(tHeap, () -> {tmb.setLong(80L, 0xcc);});
    ...
    static void blockToArrayTest() {
        ...
        Transaction.run(tHeap, () -> {tmb.setLong(90L, 0xcc);});
